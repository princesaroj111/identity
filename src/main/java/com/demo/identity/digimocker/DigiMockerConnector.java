...
public class DigiMockerConnector {
  private static final String AUTH_TOKEN =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9"
          + ".eyJfaWQiOiI2NDI5MDZlNjllYWQ0NDM4OWRiY2VhYTYiLCJpYXQiOjE2ODA1NzQ2NzV9"
          + ".JRLJ8XZaBxnGN-oFABzYM9dsFQt-otWyv2BzbXFaODk";

  private static DigiMockerResponse fetchCollegeCredential(String name, String email)
    ...
    ResponseEntity<List> responseEntity =
        restTemplate.postForEntity(url, requestEntity, List.class);
    return new ObjectMapper().readValue(
        new ObjectMapper().writeValueAsString(responseEntity.getBody().get(0)),
        DigiMockerResponse.class);
  }
  ...
  public static boolean isCollegeCredentialValid(String name, String email, String collegeName) {
    try {
      ...
      return response != null && response.getEmail().equals(email) && response.getCollegeName()
          .equals(collegeName);
    } catch (Exception e) {
      return false;
    }
